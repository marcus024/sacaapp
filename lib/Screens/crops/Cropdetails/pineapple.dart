...
class PineappleScreen extends StatelessWidget{
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Divider(color: Colors.black38),
                        Text(
                          'Pineapple is a tropical plant with an edible fruit and it is most economically significant plant',
                          style: TextStyle(
                            fontFamily: 'Avenir',
                            fontSize: 20,
                            color: Color(0xff0e9229),
                        ...
                        Divider(color: Colors.black38),
                        Text(
                          'Pineapple is rich in manganese. Manganese plays an essential role in the way your body metabolizes food,clots blood, and keeps your bones healthy.',
                          style: TextStyle(
                            fontFamily: 'Avenir',
                            fontSize: 20,
                            color: Color(0xff0e9229),
