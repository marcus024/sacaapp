                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Divider(color: Colors.black38),
                        Text(
                          'Banana is an elongated,edible fruit and botanically a berry that produced by several kinds of large herbaceuos',
                          style: TextStyle(
                            fontFamily: 'Avenir',
                            fontSize: 20,
                            color: Color(0xff0e9229),
                        ...
                        Divider(color: Colors.black38),
                        Text(
                          'Bananas are rich in mineral potassium. Potassium helps maintain Trusted Source fluid levels in the body and regulates the movement of nutrients and waste products',
                          style: TextStyle(
                            fontFamily: 'Avenir',
                            fontSize: 20,
                            color: Color(0xff0e9229),
