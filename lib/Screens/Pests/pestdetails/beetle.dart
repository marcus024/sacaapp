...
class BeetleScreen extends StatelessWidget{
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Divider(color: Colors.black38),
                        Text(
                          'Beetles are insects that from the order Coleoptera, in the superorder Endop-terygota',
                          style: TextStyle(
                            fontFamily: 'Avenir',
                            fontSize: 20,
                            color: Color(0xff0e9229),
                        ...
                        Divider(color: Colors.black38),
                        Text(
                          'The soil in your garden should be loose and well watered regularly. Cover your plants with floating row cover. The plants need to be covered during the period of the time when beetles fly.',
                          style: TextStyle(
                            fontFamily: 'Avenir',
                            fontSize: 20,
                            color: Color(0xff0e9229),
