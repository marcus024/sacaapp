...
class SawflyScreen extends StatelessWidget{
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Divider(color: Colors.black38),
                        Text(
                          'Sawflies are the insects of the suborder Symphyta within th order Hymenoptera alongside ants,bees and wasps.',
                          style: TextStyle(
                            fontFamily: 'Avenir',
                            fontSize: 20,
                            color: Color(0xff0e9229),
                        ...
                        Divider(color: Colors.black38),
                        Text(
                          'Cultivate around trees and shrubs in the early spring to help reduce the overwhelming population. Wash slugs off leaves with a strong jet of water from the Bug Blaster',
                          style: TextStyle(
                            fontFamily: 'Avenir',
                            fontSize: 20,
                            color: Color(0xff0e9229),
